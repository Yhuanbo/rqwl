! function(i) {
		...
		animate: function(t, n) {
			...
			i.each(t, function() {
				...
				a && (c += a, l -= a), i(this).css({
					...
					"hidden"), i(this).removeClass(t), i(this).removeClass("animated"))
			})
		}
	};
	jQuery.fn.scrolla = function(t) {
		return t = i.extend({
			mobile: !1,
			once: !1
		}, t), (t.mobile !== !1 || !/Android|webOS|iPhone|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator
			.userAgent)) && void a.init(this, t)
	}
}(jQuery);
